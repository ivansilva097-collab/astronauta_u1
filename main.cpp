...
void lancarVoo(int codigo) {
    ...
    if ((int)voos[iv].cpfsPassageiros.size() == 0) {
    ...
    for (int estado = 0; estado <= 3; estado++) {
        ...
        for (int i = 0; i < (int)voos.size(); i++) {
            if (voos[i].estado == estado) {
                ...
                if ((int)voos[i].cpfsPassageiros.size() == 0) {
    ...
    for (int i = 0; i < (int)astronautas.size(); i++) {
        if (!astronautas[i].vivo) {
            ...
            if ((int)astronautas[i].voosCursados.size() == 0) {
                ...
                for (int j = 0; j < (int)astronautas[i].voosCursados.size(); j++) {
                    cout << astronautas[i].voosCursados[j];
                    if (j < (int)astronautas[i].voosCursados.size() - 1) cout << ", ";
                }
            }
            cout << endl;
        }
